package com.example.superlotto.Fragment;
...
import com.example.superlotto.Activity.BaseFragment;
...
public class SupperLottoFragment extends BaseFragment implements View.OnClickListener,SelectedNumberSuperLottoAdapter.SelectedNumberSuperLottoClick {
...
public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        SupperLottoFragment.this.isChecked = isChecked;
        }
        });
        ...
        addHelpBanner();
        setupSelectedNumbers();
        }
        private void setupSelectedNumbers() {
                recyclerSelectedNumbers.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
                selectedNumberSuperLottoAdapter = new SelectedNumberSuperLottoAdapter(this, getActivity());
                selectedNumberSuperLottoAdapter.setSelectedNumberLottos(selectedNumbers);
                recyclerSelectedNumbers.setAdapter(selectedNumberSuperLottoAdapter);
        }
...
public void onClick(View view) {
        ...
        @Override
        public void selectedNumberLottoClickListener(SelectedNumber selectedNumberLotto) {
